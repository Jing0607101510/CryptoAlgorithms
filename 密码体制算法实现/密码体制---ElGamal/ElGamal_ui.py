...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.line.setGeometry(QtCore.QRect(0, 160, 581, 16))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.label_8 = QtWidgets.QLabel(Form)
        self.label_8.setGeometry(QtCore.QRect(20, 180, 72, 15))
        self.label_8.setObjectName("label_8")
        self.textEdit_1 = QtWidgets.QTextEdit(Form)
        self.textEdit_1.setGeometry(QtCore.QRect(70, 180, 491, 111))
        self.textEdit_1.setObjectName("textEdit_1")
        self.label_9 = QtWidgets.QLabel(Form)
        self.label_9.setGeometry(QtCore.QRect(20, 310, 72, 15))
        self.label_9.setObjectName("label_9")
        self.textBrowser_1 = QtWidgets.QTextBrowser(Form)
        self.textBrowser_1.setGeometry(QtCore.QRect(70, 310, 491, 121))
        self.textBrowser_1.setObjectName("textBrowser_1")
        self.encry = QtWidgets.QPushButton(Form)
        self.encry.setGeometry(QtCore.QRect(70, 450, 93, 28))
        self.encry.setObjectName("encry")
        self.clear1 = QtWidgets.QPushButton(Form)
        self.clear1.setGeometry(QtCore.QRect(190, 450, 93, 28))
        self.clear1.setObjectName("clear1")
        self.line_2 = QtWidgets.QFrame(Form)
        self.line_2.setGeometry(QtCore.QRect(0, 500, 581, 16))
        ...
        self.gen_key.setGeometry(QtCore.QRect(70, 130, 93, 28))
